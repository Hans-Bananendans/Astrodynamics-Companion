## General styling convention
See [markdown cheat sheet](https://www.markdownguide.org/cheat-sheet)


1. Sections are to be separated with a horizontal line (`___`).
...
>[!warning] # DEPRICATED as of 21-09-2022:
## (old) Standard Admonition elements
