...
> - [ ] Explain that motion under the CW equation appears counter-intuitive to humans used to living on Earth, and argue that play can help here.
> - [ ] Docking question on CW will often be in the exam, and rapid interpretation of your results can save valuable time.
> - [ ] Present Python code for playing around with it
> - [ ] Present imagery (see below)

![[cwv_1.png]]
![[cwv_2.png]]

> [!python] *cw_visualizer.py*
> ```python
> #!/usr/bin/env python3
> # -*- coding: utf-8 -*-
> """
