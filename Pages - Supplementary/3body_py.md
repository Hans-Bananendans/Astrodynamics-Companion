...
#    ax.get_yaxis().set_visible(False) # Hide the grids, if you want
    ...
    dotcom, = ax.plot([], [], color='#AAAAAA', marker='x', markersize=10, 
                      linestyle='')
    
    dot1, =  ax.plot([], [], color='cyan', marker='o', markersize=10, 
                     linestyle='')
    dot2, =  ax.plot([], [], color='magenta', marker='o', markersize=10, 
                     linestyle='')
    dot3, =  ax.plot([], [], color='yellow', marker='o', markersize=10, 
                     linestyle='')
...
makeplot(tsol,Ysol,scale=scale)
